...
module Blacklight
  class DocumentTitleComponent < Blacklight::Component
    ...
    def initialize(title = nil, document: nil, presenter: nil, as: :h3, counter: nil, classes: 'header-index--sinai', link_to_document: true, document_component: nil, actions: true)
