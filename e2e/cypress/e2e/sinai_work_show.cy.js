describe('Sinai Work show pages', () => {
  it('Sinai Syriac 2A', () => {
    ...
    cy.contains('div.title-row-show--sinai', 'Sinai Syriac 2A');
    cy.percySnapshot();
  });

  it('Sinai Syriac 45', () => {
    cy.visit(Cypress.env('SINAI_BASE_URL') + '/catalog/' + encodeURIComponent('ark:/21198/z1zs40v7'));
    cy.contains('div.title-row-show--sinai', 'Sinai Syriac 45');
  ...
  it('Sinai Syriac 70', () => {
    ...
    cy.contains('div.title-row-show--sinai', 'Sinai Syriac 70');
    cy.percySnapshot();
  });
